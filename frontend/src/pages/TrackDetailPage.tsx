  ...
  return (
    <div className="min-h-screen bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Track Title Block - 907x75 */}
        <div className="w-[907px] h-[75px] mb-6">
          <h1 className="text-[30px] font-bold text-white truncate">{track.title}</h1>
        </div>
        ...
        <div className="flex flex-wrap gap-6">
          ...
          <div className="flex-shrink-0">
            {/* Cover Image - 402x402 */}
            <div className="w-[402px] h-[402px] bg-gray-800 rounded-lg shadow-lg overflow-hidden mb-4">
            ...
            <div className="w-[402px] flex gap-6 text-sm text-gray-300">
          ...
          {/* Center Column - Track Info (404x200) */}
          <div className="flex-1 min-w-[404px] max-w-[404px]">
            <div className="bg-gray-800 rounded-lg shadow-lg p-6 h-[200px]">
              {/* Track Info */}
          ...
          {/* Right Column - Purchase Block (320x256) and Action Icons */}
          <div className="flex-shrink-0">
            {/* Purchase Block - 320x256 */}
            <div className="w-[320px] bg-gray-800 rounded-lg shadow-lg p-6 mb-4">
              <div className="mb-4">
            ...
            <div className="w-[320px] bg-gray-800 rounded-lg shadow-lg px-4 py-3">
