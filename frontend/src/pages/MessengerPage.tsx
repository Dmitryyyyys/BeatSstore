...
import { MessageSquare, Send, Search, Users, Heart, Bookmark, Clock, LogOut, Settings, User, ArrowLeft, X, ShoppingBag } from 'lucide-react'
              ...
              conversations.map((conversation) => {
                ...
                return (
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    >
                      <div className="w-12 h-12 rounded-full bg-primary-100 flex items-center justify-center text-white font-semibold">
                      ...
                      {conversation.otherUser.country && getCountryFlagUrl(conversation.otherUser.country) && (
                        <div className="absolute -bottom-1 -right-1 w-5 h-5 rounded-full bg-gray-800 border-2 border-white">
                          <img
              ...
              <div className="flex items-center space-x-3">
                ...
                >
                  {selectedConversation.otherUser.avatarUrl ? (
                    ...
                    <div className="w-10 h-10 rounded-full bg-primary-100 flex items-center justify-center text-white font-semibold cursor-pointer">
          ...
          <div className="bg-gray-800 border-t border-gray-700 p-4">
            ...
            >
              ...
              <button
                ...
                className="p-2 bg-gray-800 hover:bg-gray-900 text-white rounded-full transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
