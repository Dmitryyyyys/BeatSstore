...
const EditTrackPage = () => {
  ...
  const loadTrack = async () => {
    ...
    try {
      ...
      if (track.category?.name) {
        ...
        setSelectedCategoryId(track.categoryId)
      } else {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updatedTrack = await tracksService.update(parseInt(id), trackData)
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-2 border-t border-gray-700 space-y-5">
              ...
              <MediaUploadField
                ...
                onChange={(fileUrl) => setFormData((prev) => ({ ...prev, fileUrl }))}
