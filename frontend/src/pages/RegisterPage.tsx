...
const RegisterPage = () => {
  ...
  const displayNameDebounceRef = useRef<NodeJS.Timeout>()
  ...
  return (
    <div className="h-[100dvh] overflow-y-auto bg-gray-900 px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
      <div className="max-w-md w-full mx-auto space-y-5 min-h-full flex flex-col justify-center">
        ...
        {/* Register Form */}
        <div className="bg-gray-800 rounded-2xl shadow-xl p-6 sm:p-7 border border-gray-100">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                  placeholder="••••••••"
                />
              </div>
