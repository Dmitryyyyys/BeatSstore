...
import { MessageSquare, Users, Heart, Bookmark, Clock, LogOut, Settings, User, UserPlus, UserMinus, ShoppingBag, ShoppingCart, Play, Pause, Music } from 'lucide-react'
...
import { tracksService, Track } from '../services/tracksService'
...
const SubscriptionsPage = () => {
  ...
  const handleSubscribe = async (userId: number) => {
    try {
      await subscriptionsService.subscribe(userId)
      loadData()
    } catch (error) {
                        ...
                        <div className="flex items-start space-x-4 mb-4">
                          ...
                          >
                            ...
                            {user.country && getCountryFlagUrl(user.country) && (
                              <div className="absolute -bottom-1 -right-1 w-6 h-6 rounded-full bg-gray-800 border-2 border-white">
                                <img
