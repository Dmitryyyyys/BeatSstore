...
import { MessageSquare, Users, Heart, Bookmark, Clock, LogOut, Settings, User, Search, Music, XCircle, Edit2, Trash2, Play, Pause, ShoppingBag } from 'lucide-react'
          ...
          <div className="mb-6 flex items-center space-x-4">
            ...
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 text-white placeholder-gray-400"
              />
            </div>
