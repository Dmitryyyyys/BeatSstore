...
import { MessageSquare, UserPlus, Heart, Music, Info, Camera, X, Play, Pause, Edit2, Trash2 } from 'lucide-react'
...
const ProfilePage = () => {
  ...
  const [subscriptions, setSubscriptions] = useState<PublicUser[]>([])
            ...
            <div className="flex flex-col md:flex-row md:items-start md:space-x-6">
              ...
              <div className="flex-shrink-0 mb-4 md:mb-0 relative">
                <div className="relative group">
                  <div className="w-24 h-24 md:w-32 md:h-32 rounded-full bg-primary-100 border-4 border-gray-800 shadow-lg flex items-center justify-center text-3xl md:text-4xl font-bold text-primary-600 overflow-hidden">
            ...
            <div>
              ...
              {tracksLoading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600">У продюсера пока нет треков</p>
                </div>
              ) : (
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
              ...
              <div className="space-y-6">
                ...
                {!user.profile?.phone && !user.profile?.country && !user.profile?.city && !user.profile?.bio && (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600">Информация не заполнена</p>
                  </div>
                )}
              </div>
            </div>
